...
router.get('/getVendorDetail',async(request,response)=>{
    ...
    await
    pool
    .query('select sfid ,Contact__c,con.Name as username,geographic_zone__c,District_Lower_Zone__c,Districts_Upper_Zone__c,name,vendor_Name__c ,contact_no__c,name_of_signing_authority__c,bank_details__c,pan_no__c,address__c,GST_No__c,Reason_for_not_providing_GST_no__c,Bank_IFSC_Code__c ,Bank_Account_No__c,ownerid,State__c,District__c '+
