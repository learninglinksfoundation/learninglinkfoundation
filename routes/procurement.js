...
router.get('/getProcurementDetail',async(request,response)=>{
    ...
    console.log('getProcurementITDetail Id='+procurementId);
    let procDetail={};
    let qry='SELECT proc.sfid,proc.Name as procName ,proc.Catgeory__c,proc.Total_Approved_Budget_for_the_purchase__c as purchasebudg  ,proc.Items__c ,proc.Others__c,proc.Products_Services_Name__c,vend.name as vendorName,proc.Product_Service__c,proc.Quantity__c, proc.Budget__c,proc.Impaneled_Vendor__c, '+
